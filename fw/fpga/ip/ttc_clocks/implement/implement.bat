...
xst -ifn xst.scr
move ttc_clocks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ttc_clocks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ttc_clocks_exdes.ucf ttc_clocks_exdes

echo 'Running map'
map -timing -pr b ttc_clocks_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ttc_clocks_exdes -w routed.ncd routed.vhd
cd ..
