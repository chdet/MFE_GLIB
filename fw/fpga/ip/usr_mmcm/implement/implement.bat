...
xst -ifn xst.scr
move usr_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\usr_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc usr_mmcm_exdes.ucf usr_mmcm_exdes

echo 'Running map'
map -timing -pr b usr_mmcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm usr_mmcm_exdes -w routed.ncd routed.vhd
cd ..
