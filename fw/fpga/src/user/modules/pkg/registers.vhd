...
package registers is
    ...
    constant REG_TRIGGER_NUM_REGS : integer := 41;
    ...
    constant REG_GEM_TESTS_NUM_REGS : integer := 37;
    ...
    constant REG_DAQ_NUM_REGS : integer := 30;
    ...
    constant REG_OH_LINKS_NUM_REGS : integer := 26;
    ...
    constant REG_SLOW_CONTROL_NUM_REGS : integer := 40;
